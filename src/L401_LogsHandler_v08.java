...
public class L401_LogsHandler_v08 {
    ...
    public static String logsConverter (String inRawValuableLogs) {
        ...
        System.out.println(inRawValuableLogs);
        ...
        for (int i = 0; i < content3.length(); i++) {
            ...
            String[] arrAllLogs = content3.split("/");
            System.out.println(i);

        }

        //System.out.println(arrAllLogs);

//        for (int i = 0; i < arrAllLogs.length; i++) {
//            String[] arrNeedLogs =
//            System.out.println(arrAllLogs[0] + " " + arrAllLogs[1] + " " + arrAllLogs[2] + " : " + arrAllLogs[5]);
//        }


        String outPreparedToStoreLogs = "";

        //System.out.println(arrDate[0] + " " + arrDate[1] + " " + arrDate[2] + " : " + arrDate[5]);

        return  outPreparedToStoreLogs;
    }
